    ...
    <div class="max-w-screen-xl mx-auto 2xl:px-0">
        <div class="lg:grid lg:grid-cols-5 lg:gap-8 xl:gap-12">
            <div class="shrink-0 col-span-3">
                ...
                <div class="border-t mt-[2.6rem] pt-[2.2rem] pb-2">
                    <div class="flex">
            ...
            <div class="col-span-2 bg-sky-50 rounded-xl p-8 mt-6 sm:mt-8 lg:mt-0">
                ...
                <div class="mb-8">
                    <p class="text-gray-900 dark:text-gray-300 font-semibold text-md mt-4">Date</p>
                    <div date-rangepicker class="flex items-center py-3 -mb-4">
                        <div class="relative">
                            ...
                            <input name="start" id="start-date" type="text"
                                class="bg-gray-50 shadow border-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
