                ...
                <div class="flex justify-center items-center">
                    <label for="profile-file"
                        ...
                        <div class="flex flex-col items-center justify-center relative">
                            <svg id="svg-icon"
                                class="w-12 h-12 text-gray-500 dark:text-gray-400 {{ $user->profile_photo ? 'hidden' : '' }}"
                            ...
                            <img id="profile-image-preview" src="{{ asset($user->profile_photo) }}"
                                class="w-[60px] h-[60px] {{ $user->profile_photo ? '' : 'hidden' }} object-cover object-center rounded-full"
                                alt="Profile Preview" />
                        </div>
                        <input id="profile-file" type="file" name="profile_photo" class="hidden" accept="image/*" />
                    </label>
