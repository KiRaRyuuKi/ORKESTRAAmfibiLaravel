        ...
        <div class="max-w-screen-xl mx-auto 2xl:px-0">
            <div class="lg:grid lg:grid-cols-5 lg:gap-8 xl:gap-16">
                ...
                <div class="col-span-2 bg-gray-100 rounded-xl p-8 mt-6 sm:mt-8 lg:mt-0">
                    <span
                        class="bg-green-200 text-green-800 justify-center text-xs font-semibold px-2 py-0.5 mb-5 rounded dark:bg-blue-200 dark:text-blue-800 hidden sm:flex">
                        Recomendasi
                    </span>
                    <h1 class="mb-5 text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                    ...
                    <div class="my-5">
                        <p class="text-gray-900 dark:text-gray-300 font-semibold text-md">Pickup</p>
