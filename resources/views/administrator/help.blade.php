<x-app-layout>
    <section class="bg-white p-5 rounded-xl dark:bg-gray-900">
        <div class="p-6 mx-auto max-w-screen-xl">
            ...
            <div class="my-5">
                <h3 class="text-xl tracking-tight font-extrabold text-gray-900 dark:text-white">
            ...
            <div class="pt-8 text-left">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">We're aware of the importance of well qualified
                        ...
                        actually worked on this project. Feel free to
                        <a href="#"
                            class="font-medium underline text-blue-600 dark:text-blue-500 hover:no-underline"
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        ...
                        dashboard page with the mobile version alongside it. You can use this version for any purposes,
                        because
