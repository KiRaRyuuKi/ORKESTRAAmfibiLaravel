<x-app-layout>
    @if ($showrooms && $showrooms->count())
        @foreach ($showrooms as $showroom)
            <form action="{{ route('administrator.pengaturan.update', $showroom->id) }}" method="POST"
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-banner"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6 absolute inset-0"
                                    id="dropzone-banner-preview" style="{{ $showroom->banner ? 'display: none;' : '' }}">
                                ...
                                <div class="flex justify-center items-center">
                                    <label for="profile-file"
                                        ...
                                        <div class="flex flex-col items-center justify-center relative">
                                            ...
                                            <img id="profile-image-preview" src="{{ asset($showroom->profile_photo) }}"
