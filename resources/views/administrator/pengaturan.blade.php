    ...
    <form>
        <div class="space-y-12">
            <div class="gap-x-6 gap-y-8">
                ...
                <div class="py-8">
                    <label class="block text-md font-medium mb-3 text-gray-900 dark:text-white" for="file_input">
                        Upload Profile
                    </label>
                    <div class="flex">
                        <div class="flex justify-center items-center">
                            <label for="profile-file"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg class="w-12 h-12 mt-1 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                ...
                                <input id="profile-file" type="file" class="hidden" />
                            </label>
                        </div>
                        <div class="ms-5 w-full justify-center items-center">
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="profile-file">
        ...
        <div class="flex w-full mt-10 justify-end">
            <button type="button"
                class="flex text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg px-12 py-2 text-ms text-center me-2">
                Save
            </button>
        </div>
    </form>
