<x-app-layout>
    <div class="bg-white p-8 rounded-xl">
        ...
        <form action="{{ route('data-mobil.store') }}" method="POST" enctype="multipart/form-data" class="pt-8">
            @csrf
            ...
            <div class="grid gap-8 mb-4 sm:grid-cols-2">
                <div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="dropzone-image-1"
                            ...
                            <img id="image-1-preview" src=""
                                class="w-full h-full object-cover rounded-lg hidden" alt="Image 1 Preview" />
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-image-2"
                                ...
                                <img id="image-2-preview" src=""
                                    class="w-full h-full object-cover rounded-lg hidden" alt="Image 2 Preview" />
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-image-3"
                                ...
                                <img id="image-3-preview" src=""
                                    class="w-full h-full object-cover rounded-lg hidden" alt="Image 3 Preview" />
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-image-4"
                                ...
                                <img id="image-4-preview" src=""
                                    class="w-full h-full object-cover rounded-lg hidden" alt="Image 4 Preview" />
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-image-5"
                                ...
                                <img id="image-5-preview" src=""
                                    class="w-full h-full object-cover rounded-lg hidden" alt="Image 5 Preview" />
                ...
                <div class="grid grid-cols-3 gap-8 col-span-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="license_plate" id="license_plate"
                            pattern="[A-Z]{1}\s\d{4}\s[A-Z0-9]{2}"
                            title="License plate must match the format: (A-Z{1}) (0-9{4}) (A-Z, 0-9{2})"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-6 gap-2 p-5 border rounded-lg bg-gray-50 border-gray-300">
                        <div class="flex items-center me-4">
                            <input id="air-conditioner" type="checkbox" value="AirConditioner"
                        ...
                        <div class="flex items-center me-4">
                            <input id="power-door-locks" type="checkbox" value="PowerDoorLocks"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center me-4">
                            <input id="brake-assist" type="checkbox" value="BrakeAssist"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="brake-assist"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Brake Assist</label>
                        </div>
                        <div class="flex items-center me-4">
                            <input id="power-steering" type="checkbox" value="PowerSteering"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center me-4">
                            <input id="driver-airbag" type="checkbox" value="DriverAirbag"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center me-4">
                            <input id="power-windows" type="checkbox" value="PowerWindows"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="power-windows"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Power Windows</label>
                        </div>
                        <div class="flex items-center me-4">
                            <input id="cd-player" type="checkbox" value="CDPlayer"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="cd-player"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">CD
                                Player</label>
                        </div>
                        <div class="flex items-center me-4">
                            <input id="central-locking" type="checkbox" value="CentralLocking"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center me-4">
                            <input id="crash-sensor" type="checkbox" value="CrashSensor"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="crash-sensor"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Crash Sensor</label>
                        </div>
                        <div class="flex items-center me-4">
                            <input id="leather-seats" type="checkbox" value="LeatherSeats"
                                class="accessory-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="8"
                        ...
                        placeholder="Write car description here..."></textarea>
                </div>
            </div>
            <button type="submit"
