        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr
                    ...
                    <th scope="row"
                        class="flex items-center align-top px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                        <div>
                            <img class="w-28 h-20 rounded bg-black" src="/docs/images/people/profile-picture-1.jpg"
                                alt="Jese image">
                            <div class="text-base font-semibold">Nama Mobil</div>
                            <div class="font-normal text-gray-500">Merek Mobil</div>
                        </div>
                    </th>
                    <td class="px-6 py-4 text-justify align-top">
                    ...
                    <td class="px-6 py-4 align-top">
                        <div class="bg-green-400 text-white px-5 py-2 font-bold shadow rounded-lg">
                            Lunas
                        </div>
                    </td>
                    <td class="px-6 py-4 align-top">
