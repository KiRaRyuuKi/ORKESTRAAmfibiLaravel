                            ...
                            <ul id="dropdown-data-mobil" class="hidden py-2 space-y-2">
                                <li>
                                    ...
                                    <a href="/administrator/data-mobil/merek-&-kategori"
                                        class="flex items-center w-full p-2 text-sm text-gray-900 transition duration-75 rounded-lg pl-10 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                        <svg class="me-2 text-gray-500" xmlns="http://www.w3.org/2000/svg"
                                            width="10" height="10" fill="currentColor" class="bi bi-circle"
                                            viewBox="0 0 16 16">
                                            <path
