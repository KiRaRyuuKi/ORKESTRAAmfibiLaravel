...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `data_transaksi` SET `id_transaksi`='$id_transaksi',`id_mobil`='$id_mobil',`id_pengguna`='$id_pengguna',`tanggal_transaksi`='$tanggal_transaksi' WHERE id_transaksi = '$id'";

    $result = mysqli_query($koneksi, $sql);

    if ($result) {
        header("Location: data_transaksi.php?msg=Data updated successfully");
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <?php
        $sql = "SELECT * FROM `data_transaksi` WHERE id_transaksi = '$id' LIMIT 1";
        $result = mysqli_query($koneksi, $sql);
