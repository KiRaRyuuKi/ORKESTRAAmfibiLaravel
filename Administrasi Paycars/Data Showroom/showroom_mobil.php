...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `showroom_mobil`(`id_showroom`, `id_pengguna`, `nama_showroom`, `alamat_showroom`, `email_pemilik`, `nomor_telepon_pemilik`, `keterangan_showroom`) 

    VALUES ('$id_showroom','$id_pengguna','$nama_showroom','$alamat_showroom','$email_pemilik','$nomor_telepon_pemilik','$keterangan_showroom')";
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="edit.php?showroom_mobil=<?= $data["showroom_mobil"] ?>"><i class="bx bx-edit-alt me-2"></i> Edit</a>
                                    <a class="dropdown-item" href="delete.php?showroom_mobil=<?= $data["showroom_mobil"] ?>"><i class="bx bx-trash me-2"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
